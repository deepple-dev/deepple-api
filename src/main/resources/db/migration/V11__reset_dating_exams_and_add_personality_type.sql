-- ===================================
-- 1) 기존 데이터 삭제 (submit → answer → question → subject 순서)
-- ===================================
DELETE
...
-- ===================================
-- 2) members 테이블의 is_dating_exam_submitted를 전체 false로 초기화
-- ===================================
UPDATE members
SET is_dating_exam_submitted = FALSE;

-- ===================================
-- 3) dating_exam_answer 테이블에 personality_type 컬럼 추가
-- ===================================
ALTER TABLE dating_exam_answer
    ADD COLUMN personality_type VARCHAR(50) NOT NULL;

-- ===================================
-- 4) 새 과목 4개 INSERT (모두 REQUIRED)
-- ===================================
SET
@now = NOW(6);
